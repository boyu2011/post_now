...
describe UsersController do
	...
	describe "GET 'index'" do
		...
		describe "for signed-in users" do
			...
			it "should have the right title" do
				get :index
				response.should have_selector("title", :content => "Post Now App | All users")
			end
	...
	describe "GET 'show'" do
		...
		it "should show the user's microposts" do
			mp1 = Factory(:micropost, :user => @user, :content => "test message")
			mp2 = Factory(:micropost, :user => @user, :content => "test message2")
			get :show, :id => @user
	...
	describe "DELETE 'destroy'" do
		...
		describe "as an admin user" do
			...
			before(:each) do
				admin = Factory(:user, :email => "admin@postnow.com", :admin => true)
				test_sign_in(admin)
			end
